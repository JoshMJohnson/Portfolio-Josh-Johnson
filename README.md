...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------ | :------------------------ | :------------------------------------: |
| [Tic&ndash;Tac&ndash;Toe](/TicTacToe) | Python | <ul><li>GUI Interface</li><li>Timer Usage</li><li>Tables</li><li>Buttons</li><li>Random Integer Generation</li></ul> | Tic&ndash;Tac&ndash;Toe game where the user plays against the program |
