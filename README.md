...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Tic&ndash;Tac&ndash;Toe](/TicTacToe) | <p align="center">Python</p> | <ul><li>Timer Usage</li><li>Pop&ndash;Up Message Boxs</li><li>Arrays</li><li>Tables</li><li>Frames</li><li>Buttons</li><li>Random Integer/Float Generation</li><li>Python Libraries<ul><li>Tkinter</li><li>Random</li><li>Time</li></ul></li></ul> | Tic&ndash;Tac&ndash;Toe game where the user can play against the AI or another human player |
...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------ | :------------------------------------: |
| [Chess](/Chess) | Python | <ul><li>Alpha Blending</li><li>Hash Tables</li><li>Instances</li><li>Class Interactions</li><li>Mouse Coordinates</li><li>User Input</li><li>2-Dimensional Arrays</li><li>Font Usage</li><li>Absolute Pathing</li><li>Image Processing</li><li>Python Libraries<ul><li>Pygame</li><li>Random</li><li>Time</li><li>OS</li></ul></li></ul> | Loads up a chess board and allows the game of chess to be played |
