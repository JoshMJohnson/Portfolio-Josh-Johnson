...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Chess](/Chess) | <p align='center'>Python</p> | <ul><li>Alpha Blending</li><li>Hash Tables</li><li>Instances</li><li>Mouse Coordinates</li><li>User Input</li><li>2-Dimensional Arrays</li><li>Image Processing</li><li>Python Libraries<ul><li>pygame</li><li>os</li><li>sys</li><li>threading</li><li>time</li></ul></li></ul> | Loads up a chess board and allows the game of chess to be played |
