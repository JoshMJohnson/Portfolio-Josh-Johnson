...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------: | :------------------------------------: |
| Stock Tracker App | C# | .NET MAUI | App used to provide notifications on big stock price changes within a watchlist created by the user. Available cross platform. |
