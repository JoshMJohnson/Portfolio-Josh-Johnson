...
<img src="/Portfolio_Assets/official_icon_jjhub.png" alt="Josh Johnson Hub Logo" width="20%" height="12%">
...
[<img src="./Portfolio_Assets/List_Maker_Featured.jpg" width="90%">](https://youtu.be/5cZ8tYVaUUU)
</div>
...
[<img src="./Portfolio_Assets/Alarm_Hub_Featured.jpg" width="90%">](https://youtu.be/B8QdJpr24Ts)
</div>
...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Napster Streaming](https://github.com/JoshMJohnson/Portfolio-Josh-Johnson/tree/main/NapsterStreaming) | <p align='center'>JavaFX</p> | <ul><li>JavaFX Framework</li><li>VLCJ</li><li>SQLite</li><li>Cross-Drive File Navigation</li></ul> | A media playback software developed using JavaFX |
| [Stock Alert](https://github.com/JoshMJohnson/Stock_Alert) | <p align='center'>Dart</p> | <ul><li>Flutter Framework</li><li>Isolates</li><li>SQLite</li><li>Preferences</li><li>Foreground Service</li><li>Scheduled Local Notifications</li><li>Twelve Data API</li><li>Stack Navigation</li><li>Multi-Theming</li></ul> | Keeps you updated on the stock market by alerting you when major changes happen on your watchlist |
