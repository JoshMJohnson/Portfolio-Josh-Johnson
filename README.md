...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Tic&ndash;Tac&ndash;Toe](/TicTacToe) | <p align="center">Python</p> | <ul><li>GUI Interface</li><li>Timer Usage</li><li>Pop&ndash;up Message Box</li><li>Arrays</li><li>Tables</li><li>Frames</li><li>Buttons</li><li>Random Integer/Float Generation</li></ul> | Tic&ndash;Tac&ndash;Toe game where the user plays against the program |
...
| [Speed&lowbar;Force&lowbar;Prison&lowbar;Game](/Speed_Force_Prison_Game)  | <p align="center">Java</p> | <ul><li>3&ndash;Dimensional Rendering</li><li>Sprites</li><li>User Input<ul><li>Keyboard</li><li>Mouse</li></ul></li><li>JFrames&sol;JPanels<ul><li>JButtons</li><li>JLabels</li><li>JTextFields</li></ul></li><li>Timer Usage</li><li>Image Usage</li><li>Threads</li><li>Java Class Interaction</li></ul> | 3&ndash;Dimensional game written in Java that uses Java&apos;s graphical interface for rendering effects |
