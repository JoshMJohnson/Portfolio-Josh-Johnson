...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------ | :------------------------------------: |
| 'List Maker' Mobile Application | JSX | <ul><li>React Native Framework</li><li>Expo</li><li>Node JS</li><li>Local Storage<ul><li>Database (SQLite)</li><li>Async Storage</li></ul><li>Global StyleSheet</li><li>React Navigation</li></ul> | 'List Maker' mobile application built using React Native |
