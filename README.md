...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Tic&ndash;Tac&ndash;Toe](/TicTacToe) | Python | <ul><li>GUI Interface</li><li>Timer Usage</li><li>Pop&ndash;up Message Box</li><li>Arrays</li><li>Tables</li><li>Frames</li><li>Buttons</li><li>Random Integer/Float Generation</li></ul> | Tic&ndash;Tac&ndash;Toe game where the user plays against the program |
