...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------ | :------------------------ | :------------------------------------: |
| Tic&ndash;Tac&ndash;Toe | Python | <ul><li>GUI Interface</li><li>Random Integer Generation</li></ul> | Tic&ndash;Tac&ndash;Toe game where the user plays against the program |
