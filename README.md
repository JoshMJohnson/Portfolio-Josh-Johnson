...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------ | :------------------------ | :------------------------------------: |
| Todo Application | <ul><li>HTML</li><li>CSS</li><li>JavaScript</li><li>JSX</li></ul> | <ul><li>React JS</li><li>React Native</li></ul> | Simple todo list application. Contains React JS for web version and React Native for mobile version. |
