...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------ | :------------------------------------: |
| [Chess](/Chess) | Python | <ul><li>Alpha Blending</li><li>Hash Tables</li><li>Instances</li><li>Class Interactions</li><li>Mouse Coordinates</li><li>2-Dimensional Arrays</li><li></li><li>Absolute Pathing</li><li>Image Processing</li><li>Python Libraries<ul><li>Pygame</li><li>Random</li><li>Time</li><li>OS</li></ul></li></ul> | Loads up a chess board and allows the game of chess to be played |
