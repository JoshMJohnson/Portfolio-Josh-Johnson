...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------ | :------------------------ | :------------------------------------: |
| Account_Manager | <ul><li>HTML</li><li>CSS</li><li>SQL</li><li>JavaScript</li></ul> | <ul><li>User Permissions</li><li>Forms Usage<ul><li>Password</li><li>Text</li></ul></li><li>Node JS</li><li>Server Side vs. Client Side</li></ul> | Allows user to create&sol;delete accounts and be able to login&sol;logout of such accounts |
