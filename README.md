...
| [Ultimate&lowbar;Frisbee&lowbar;Wiki](/Ultimate_Frisbee_Project) | <ul><li>HTML</li><li>CSS</li></ul> | <ul><li>Links<ul><li>Anchor</li><li>Absolute</li></ul></li><li>Images Usage</li><li>Quotes</li><li>Lists<ul><li>Sorted</li><li>Unsorted</li></ul></li></ul> | Customized ultimate frisbee Wiki page |
---
...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------ | :------------------------ | :------------------------------------: |
| [Account&lowbar;Manager](/Account_Manager) | <ul><li>HTML</li><li>CSS</li><li>JavaScript</li><li>SQL</li></ul> | <ul><li>User Permissions</li><li>Forms Usage<ul><li>Password</li><li>Text</li></ul></li><li>Node JS</li><li>Server Side vs. Client Side</li></ul> | Allows user to create&sol;delete accounts and be able to login&sol;logout of such accounts |
