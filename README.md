...
| :------------------------: | :------------------------ | :----------------------- | :------------------------------------: |
| [Tic&ndash;Tac&ndash;Toe](/TicTacToe) | <p align="center">Python</p> | <ul><li>GUI Interface</li><li>Timer Usage</li><li>Pop&ndash;up Message Box</li><li>Arrays</li><li>Tables</li><li>Frames</li><li>Buttons</li><li>Random Integer/Float Generation</li></ul> | Tic&ndash;Tac&ndash;Toe game where the user can play against the AI or another human player |
...
| [List Management](/Python/ListManagement.py) | Python | <ul><li>Better Comments Extension</li><li>List Specifications</li><li>Insertion</li><li>Deletion</li><li>Element Locating</li><li>Element Manipulation</li></ul>  | Demonstrates array functions |
...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------ | :------------------------------------: |
| Array Management | JavaScript | <ul><li>Better Comments Extension</li><li>Array Specifications</li><li>Insertion</li><li>Deletion</li><li>Element Locating</li><li>Element Manipulation</li></ul>  | Demonstrates array functions |
