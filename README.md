...
<div align="center">
    <small>Record tasks quickly and efficiently without the need of paper &amp; pens from anywhere!
    Android application built using the React Native Expo Framework.</small>
</div>
