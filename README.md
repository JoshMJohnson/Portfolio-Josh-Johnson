...
| Project | Language&lpar;s&rpar; | Concepts Demonstrated | Description |
| :------------------------: | :------------------------: | :------------------------ | :------------------------------------: |
| To-Do Mobile Application | JSX | <ul><li>React Native Framework</li><li>Node JS</li><li>Expo</li><li>Local Storage<ul><li>Database (SQLite)</li><li>Async Storage</li></ul></ul> | 'To-Do' mobile application built using React Native |
